...
Future<void> addDummyData() async {
  ...
  final ({double min, double max, double multiplier}) randomVal =
    ...
    "Онлайн-подписки" => (min: 4.0, max: 12.0, multiplier: -3500.0),
    "Коммунальные услуги" => (min: 30.0, max: 1500.0, multiplier: 3500.0),
    "Образование" => (min: 25.0, max: 75.0, multiplier: -3500.0),
    "Покупки" => (min: 8.0, max: 100.0, multiplier: -3500.0),
    "Еда & Продукты" => (min: 8.0, max: 128.0, multiplier: -3500.0),
    "Перекус" => (min: 6.0, max: 20.0, multiplier: -3500.0),
